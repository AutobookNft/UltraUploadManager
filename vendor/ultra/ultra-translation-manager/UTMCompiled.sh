...
output_dir="/home/fabio/libraries/UTMCompiled"
...
target_dir="/home/fabio/libraries/UltraTranslationManager"
...
generate_hashes() {
    ...
    find "$target_dir" \
        ...
        -type f \( -name "*.php" -o -name "*.ts" -o -name "*.js" -o -name "*.env" -o -name "*.config.js" -o -name "*.blade.php" -o -name "*.css" -o -name "*.ico" -o -name "*.txt" -o -name "*.json" -o -name "*.md" -o -name "*.lock" \) -print | sort | while read -r file; do
