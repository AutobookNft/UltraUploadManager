...
source_dir="/home/fabio/libraries/UltraTranslationManager"

# Ottieni la data e l'ora corrente per il nome della cartella di destinazione
timestamp=$(date +"%Y%m%d_%H%M")
backup_name="UTM_${timestamp}"
...
# Messaggio iniziale
echo "Avvio backup di Ultra Translation Manager nella directory ${dest_dir}"
echo "Avvio: $(date)"
...
echo "Backup UTM completato: $(date)" > "${dest_dir}/backup_info.txt"
