...
<div class="max-w-5xl mx-auto mt-12 p-8 bg-gradient-to-br from-gray-800 via-purple-900 to-blue-900 rounded-2xl shadow-2xl border border-purple-500/30 relative nft-background"
    ...
    <!-- Enterprise Features Badges (Punto 4) -->
    ...
    {{-- <!-- Max file size reminder with neon green accent (Migliorato per Accessibilità - Punto 5) -->
    ...
    <!-- Metadati semplificati (Punto 3) -->
    <div class="bg-gray-800/50 rounded-xl p-5 mb-6 border border-purple-500/30">
        <h3 class="text-lg font-semibold text-white mb-3">{{ trans('uploadmanager::uploadmanager.quick_egi_metadata') }}</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label for="egi-title" class="block text-sm font-medium text-gray-200 mb-1">{{ trans('uploadmanager::uploadmanager.egi_title') }}</label>
            ...
            <div>
                <label for="egi-collection" class="block text-sm font-medium text-gray-200 mb-1">{{ trans('uploadmanager::uploadmanager.egi_collection') }}</label>
                <select id="egi-collection" name="egi-collection"
                        class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                    <option value="">{{ trans('uploadmanager::uploadmanager.select_collection') }}</option>
                    <option value="existing">{{ trans('uploadmanager::uploadmanager.existing_collections') }}</option>
                    <option value="new">{{ trans('uploadmanager::uploadmanager.create_new_collection') }}</option>
                </select>
            </div>
            <div class="md:col-span-2">
                <label for="egi-description" class="block text-sm font-medium text-gray-200 mb-1">{{ trans('uploadmanager::uploadmanager.egi_description') }}</label>
    ...
    <div class="mt-6 space-y-6">
     ...
     <!-- Action buttons with EGI style and tooltips (Punto 5) -->
    ...
    <!-- Previews grid - Moved before action buttons for better UX -->
